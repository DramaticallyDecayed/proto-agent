 ...
 */
public class GenerativeInitialExtender extends ProgramElementGenerator {


    public GenerativeInitialExtender(ProgramStructureGenerator psg) {
        super(psg);
    }
    ...
    private JDefinedClass addDerivativeCreator(JDefinedClass jdc, String derivativeName) {
        ...
        jdc.method(JMod.PUBLIC, derivativeClass, "create" + derivativeName)
                .body()
