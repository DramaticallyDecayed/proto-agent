package dd.sas.pipeline.calculation.structure.nodes.generativenodes;

import dd.sas.pipeline.calculation.structure.flows.generativeflows.InitialObjectFlow;
