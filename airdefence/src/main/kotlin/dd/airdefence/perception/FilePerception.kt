...
class FilePerception: APerception(mutableListOf(), mutableListOf()){

    val LOG = LoggerFactory.getLogger(FilePerception::class.java)
    ...
    init {
        val scenarioFilePath = FilePerception::class.java.classLoader.getResource("scenario.csv").path
